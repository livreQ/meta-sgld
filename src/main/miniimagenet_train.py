import  torch, os
import  numpy as np
from    src.utils.MiniImagenet import MiniImagenet
import  scipy.stats
...
def main():
    ...
    mini = MiniImagenet(args.data_dir, mode='train', n_way=args.n_way, k_shot=args.k_spt,
                        k_query=args.k_qry,
                        batchsz=10000, resize=args.imgsz)
    mini_test = MiniImagenet(args.data_dir, mode='test', n_way=args.n_way, k_shot=args.k_spt,
                             k_query=args.k_qry,
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--mcmc_times', type=int, help='mcmc times', default=3)
    ...
    argparser.add_argument('--temp', type=int, help='sgld temparature', default=1000000)
    ...
    argparser.add_argument('--data_dir', type=str, help='data directory', default="./")
